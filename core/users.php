<?php
 ...
 /* TEMP PASSWORD FOR ONBOARDING EMPLOYEES   */
    ...
    function onboarding_checklist_notification($employee, $supervisor)
    {
        $subject = "Employee Checklist Updated";
        if($_ENV["HOSTNAME"] == "PRODUCTION")
        {
            $mail = "hr@convorelay.com";
        }
        ...
        $body = "Hi " . $employee["firstName"] . ", <br/><br/>" .  "<br/>This email is to officially welcome you to Convo family. We have cleared your background check and you are good to go to begin training and employment with Convo. Your manager " . $supervisor["fullName"] . " will be in touch with you.<br/><br/><br/>" .
            "-Convo HR team";

        sendEmail($mail,  $subject, $body, $body);

        $body = "Hi" . $supervisor["firstName"] .", <br/><br/>".
        $employee["fullName"] ." has been cleared to start training and employment with Convo. Please enter his/her start date information on Portal.<br/><br/>Thank you,<br/>HR Team";

<nav id="primaryNav">
    <ul>
        ...
        ?>
        <li>
            <a href="<?php echo $linkToALL;?>/NEO/index.php">New Employee Onboarding</a>
        </li>
        <?php
            }
        ...
        ?>
        <li>
            <a href="<?php echo $linkToALL;?>/index.php">Home</a>
        </li>
        <li>
            <a href="#">HR</a>
            <ul class="HR">
        ...
        <li>
            ...
            <ul class="HR">
                <li>
                    <a href="<?php echo $linkToALL;?>/HR/resources.php">Resources</a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/HR/fmla.php">Family Medical Leave</a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/HR/employment_data.php">Employee Data</a>
                </li>
        ...
        <li>
            ...
            <ul class="HR">
                ...
                ?>
                <li>
                    <a href="<?php echo $linkToALL;?>/Benefits/overview.php">Overview</a>
                </li>
                <?php
                }
                ...
                ?>
                <li>
                    <a href="<?php echo $linkToALL;?>/Benefits/401k.php">401(k)</a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/Benefits/medical.php">Medical</a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/Benefits/dental_vision.php">Dental/Vision</a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/Benefits/FSA.php">Flexible Spending Account</a>
                </li>
                <?php
                }
                ?>
                <li>
                    <a href="<?php echo $linkToALL;?>/Benefits/supplemental.php">Supplemental</a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/Benefits/EAP.php">Employee Assistance Program</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="finance_menu">
                <li>
                    <a href="<?php echo $linkToALL;?>/Finance/travel_request.php">Travel Reimbursement Form </a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/Finance/finance.php">Travel &amp; Reimbursement Policy</a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/Finance/Travel_Request_Form.xlsx">Travel Request Form (Excel)</a>
                </li>
                <li>
                    <a href="<?php echo $linkToALL;?>/Finance/Reimbursement_Form.xlsx">Travel Reimbursement Form (Excel)</a>
                </li>
            </ul>
        </li>
        ...
        ?>
        <li>
            <a href="<?php echo $linkToALL;?>/employee.php">Employees</a>
        </li>
        <?php
        ...
        <li>
            <a href="<?php echo $linkToALL;?>/manageaccess.php">Onboarding </a>
        </li>
        <li>
            <a href="<?php echo $linkToALL;?>/Approval%20Center/index.php">
                Approval Center (<?php echo $row_count; ?>)
            </a>
        </li>
        <?php
                }
